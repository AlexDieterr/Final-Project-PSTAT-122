...
The nature of our experiment presents a couple of limitations and technical challenges. Within our blocking factor, everyone possessed different levels of hardware, specifically device differences. One person's laptop or mouse may have more or less input lag, which in turn influences reaction times. The use of a browser based test plays a role as well, as the technology introduces a level of delay that is not reflective of the subject's actual reaction time. Aside from instrumentation influences, the block effect also captures the effect of physiological differences. Not every human is built with the same reaction speed; this can be due to factors like age and overall health. Furthermore, outside factors like caffeine usage, stress, and level of rest can impact times significantly. Lastly, we utilized a straightforward approach to the music factor: quiet or with music. This binary "yes or no" approach does not account for the genre of music the subject may be listening to. The genre may impact times, as a subject could be listening to music with a significantly higher or lower tempo.
...
Therefore, we can say our model sufficiently fulfills all the assumptions.
...
Overall, the results of this study indicate that hand dominance is the strongest and most consistent factor affecting reaction time. Across all subjects, trials completed with the nondominant hand produced noticeably slower responses, and this effect remained significant even after applying the Bonferroni correction for multiple testing. In contrast, neither the music condition nor the lighting condition showed meaningful or reliable effects on performance, and their interactions did not substantially improve model fit once the correction was applied. Blocking by subject proved to be both appropriate and necessary, as subjects demonstrated considerable differences in their natural reaction speeds, and this variability contributed a large portion of the overall variation in the response. The diagnostic checks suggested that the model was appropriate. The residuals did not show issues with variance, linearity, or normality, and the independence assumption was met given how the experiment was designed. Taken together, these findings suggest that reaction time is driven primarily by individual motor characteristics rather than external conditions such as background music or lighting.

For future iterations of this experiment, it would be helpful to standardize the equipment, third-party influences, and the environment in which we conduct the test. Having everyone on the same setup, using the same laptop and mouse, would control the instrumentation noise that can impact the data. Honing in on the third-party influences that impact physiological performance, such as standardizing the use of stimulants like caffeine and the level of sleep, would help control the variation these factors introduce. Aside from standardizing, introducing a specific factor for stimulants would be another path to take. While the Human Benchmark website brings some documentation issues, the alternative plan having someone else manually time the person engaged in the experiment would introduce the issue of additional human error, as a timekeeper could easily stop the timer too early or too late. Ultimately the experiment of human reaction time, will always come with some form of uncontrollable human error.

# References

https://humanbenchmark.com/tests/reactiontime

Kandethody M. Ramachandran, Chris P. Tsokos, Chapter 9 - Analysis of variance, Editor(s): Kandethody M. Ramachandran, Chris P. Tsokos, Mathematical Statistics with Applications in R (Third Edition), Academic Press, 2021, Pages 369-414, ISBN 9780128178157, https://doi.org/10.1016/B978-0-12-817815-7.00009-9. (https://www.sciencedirect.com/science/article/pii/B9780128178157000099)
